...
function ClothApp()
{
	...
	tex.src = "img/pastToFuture.png";

	tex = new Image();
	this.texture2 = tex;
	tex.onload = function(){ _this.start(); };
	tex.src = "img/clothBg.png";
...
ClothApp.prototype = {
	start: function() {
		...
		this.mViewport = {};
		this.mViewport.w = 517;
		this.mViewport.h = 475;
		this.mViewport.ow = 240;
		this.mViewport.oh = 150;
		this.setupTransforms();

		this.generateCloth(150);
	...
	draw: function() {
		P3D.clear("", this.mViewport.w, this.mViewport.h);
	...
	updateViewTrans: function(ry) {
		...
		this.mViewFrom.x += this.mViewFromA.x * 0.1;
		this.mViewFrom.y += this.mViewFromA.y * 0.1;
		this.mViewFrom.z += this.mViewFromA.z * 0.22;
